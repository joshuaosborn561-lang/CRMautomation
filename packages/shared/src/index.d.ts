export declare const DEAL_STAGES: readonly ["replied_showed_interest", "call_meeting_booked", "discovery_completed", "proposal_sent", "negotiating", "closed_won", "closed_lost", "nurture"];
export type DealStage = (typeof DEAL_STAGES)[number];
export declare const DEAL_STAGE_LABELS: Record<DealStage, string>;
export declare const EVENT_SOURCES: readonly ["smartlead", "heyreach", "zoom_phone", "zoom_meeting", "gmail"];
